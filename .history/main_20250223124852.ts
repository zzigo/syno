	...
	private async playSound(input: string, vuMeter: HTMLElement, playButton: HTMLElement) {
		...
		try {
			...
			for (const line of lines) {
				...
				if (!this.audioContext) {
					console.error("AudioContext is null AGAIN right before setting oscillator frequency");
					return;
				}
				if (!this.audioContext) {
					console.error("AudioContext is unexpectedly null AGAIN right before setting oscillator frequency");
					return;
				}
