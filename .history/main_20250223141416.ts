...
export default class SynoPlugin extends Plugin {
        ...
        this.registerEvent(
            this.app.workspace.on("editor-change", (editor) => {
                ...
                if (view && view.getMode() === "source") {
                    ...
                    this.processInlineSyno(contentEl, { docId: view.file?.path || "" } as any);
                }
            })
        );
    }
    ...
    private processSynoBlock(source: string, el: HTMLElement, ctx: any) {
        ...
        // Use CodeMirror for Python highlighting
        ...
        require("obsidian").CodeMirror.runMode(source, "python", code);
    ...
    private processInlineSyno(el: HTMLElement, ctx: any) {
        ...
        let updatedContent = textContent.replace(/&amp;/g, "&"); // Decode &amp; first
        ...
        el.querySelectorAll(".syno-inline-synth").forEach((elem) => {
            ...
            require("obsidian").CodeMirror.runMode(code.textContent || "", "python", code);
        });
