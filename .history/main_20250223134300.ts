...
export default class SynoPlugin extends Plugin {
    ...
    private createAndStartNode(parsed: ReturnType<typeof this.parseInput>, blockVolume?: { start: number; end?: number; duration?: number } | null, blockPan?: { start: number; end?: number; duration?: number } | null, blockEq?: number[] | null) {
        ...
        const effectiveFreq = rampTarget ? { start: frequency, end: rampTarget, duration: 2 } : frequency;
    ...
    private parseInput(input: string) {
        ...
        return {
            ...
            frequency,
            rampTarget: null, // Legacy .ramp() replaced by .freq()
            volume,
            pan,
            eq,
        };
