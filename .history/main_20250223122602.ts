		...
		try {
			...
			for (const line of lines) {
				...
				if (rampTarget !== null) {
					...
					osc.frequency.setTargetAtTime(rampTarget, this.audioContext.currentTime, 2);
					setTimeout(() => {
						osc.frequency.setTargetAtTime(frequency, this.audioContext!.currentTime + 2, 2);
					}, 2000);
				}
			}
